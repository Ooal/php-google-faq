...
<div style="margin: 5% 20%; font-family: Roboto,arial,sans-serif; color:rgba(0,0,0,0.87)">
    <?php
    foreach ($arr as $domanda => $risposte) {
      ?>
      <h1 style="font-size:24px ; font-weight: 500; color: #3c4043">
        <?php
        echo $domanda;
         ?>
      </h1>
